...
import {
    GET_KINDERGARTEN_ALL_SUCCESS,
    GET_KINDERGARTEN_ALL_ERROR,
    RESET_KINDERGARTEN_ALL,
    ADD_KINDERGARTEN_SUCCESS,
    ADD_KINDERGARTEN_ERROR,
    EDIT_KINDERGARTEN_SUCCESS,
    EDIT_KINDERGARTEN_ERROR,
    RESET_TRIGGER
...
export default function dictionary(state = initialState, action = {}) {
    ...
    switch (action.type) {
        ...
        case ADD_KINDERGARTEN_ERROR:
            return Object.assign({}, state, {triggerStateChange: 3501});
        case EDIT_KINDERGARTEN_SUCCESS:
        ...
        case EDIT_KINDERGARTEN_ERROR:
            return Object.assign({}, state, {triggerStateChange: 6501});
        case RESET_KINDERGARTEN_ALL:
            return initialState;
        case RESET_TRIGGER:
